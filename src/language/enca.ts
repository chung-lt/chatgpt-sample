export default {
    ...
    home: {
        ...
        subSidebar: {
            ...
            dialogue: {
                deleteConversation: {
                    ...
                    description:
                        'This action will permanently delete the data. Are you sure you want to proceed?'
                }
            }
        },
        searchAgent: {
            ...
            label: {
                title: 'Agent',
                description:
                    'Search and create customized versions of agents that combine instructions, additional knowledge, and multiple skills.',
                searchAgent: 'Search agents',
        ...
        toast: {
            success: {
                pinAgent: 'The agent has been pinned to the sidebar',
                unpinAgent: 'The agent has been removed from the sidebar',
                linkCopy: 'The link has been copied to the clipboard',
                updateAgentAcl: 'The agent has been shared with the selected people and groups',
                deleteConversation: 'Deleted successfully',
            ...
            fail: {
                ...
                pinAgent: 'The agent could not be pinned to the sidebar'
            }
        }
    },
    ...
    group: {
        ...
        toast: {
            ...
            fail: {
                ...
                deleteGroupFail: 'Group delete unsuccessfully',
    ...
    editAgent: {
        ...
        toast: {
            ...
            fail: {
                publishAgent:
                    'Unexpected error: Cannot publish this draft agent. Please try again.',
                retrieveAgent: 'Unexpected error: Cannot retrieve agent data. Please try again.',
                createAgent: 'Unexpected error: Cannot initialize this agent. Please try again.',
