export default {
    login: {
        ...
        label: {
            ...
            title: 'Access Denied',
            descriptionDenied:
                'You do not have permission to access this resource. Please request access from the administrator.',
            logOut: 'Sign out',
        ...
        toast: {
            fail: {
                ...
                authenticationDescription: 'Please contact customer support to add your account.'
            }
        }
    },
    home: {
        ...
        subSidebar: {
            ...
            dialogue: {
                deleteConversation: {
                    ...
                    description:
                        'This will permanently delete the data. Are you sure you want to proceed?'
                }
            }
        },
        searchAgent: {
            ...
            label: {
                title: 'Agent',
                description:
                    'Search and create customised versions of agents that combine instructions, additional knowledge, and multiple skills.',
                searchAgent: 'Search agents',
        ...
        myAgent: {
            ...
            label: {
                ...
                createAgent: 'Customise agent versions for specific purposes',
                onlyMe: 'Only me',
            ...
            dialogue: {
                deleteAgent: {
                    ...
                    description:
                        'This action cannot be undone. The agent data will be permanently deleted.'
                }
            }
        },
        chat: {
        ...
        toast: {
            success: {
                pinAgent: 'Agent has been pinned to the sidebar',
                unpinAgent: 'Agent has been removed from the sidebar',
                linkCopy: 'Link copied to clipboard',
                updateAgentAcl: 'Agent has been shared with the selected people and groups',
                deleteConversation: 'Successfully deleted',
                deleteConversationDescription: 'The conversation has been deleted'
            },
            fail: {
                ...
                uploadFileFailSingle: '{fileName} could not be uploaded. Please try again.',
                uploadFileFailPlural:
                    'The following files: {fileName} could not be uploaded. Please try again.',
                pinAgent: 'Agent could not be pinned to the sidebar'
            }
        }
    },
    ...
    group: {
        ...
        myAgentsTab: {
            ...
            groupAgentFavoriteTitle: "Group {groupName}'s favourites",
        ...
        membersTab: {
            ...
            dialog: {
                ...
                importCSVDes:
                    "The file must include an email and a role on each line. The role should be 'member'",
        ...
        toast: {
            ...
            fail: {
                ...
                deleteGroupFail: 'Group deleted unsuccessfully',
    ...
    editAgent: {
        ...
        toast: {
            ...
            fail: {
                publishAgent: 'Unexpected error: Cannot publish this draft agent. Please try again',
                retrieveAgent: 'Unexpected error: Cannot retrieve agent data. Please try again.',
                createAgent: 'Unexpected error: Cannot initialise this agent. Please try again.',
                updateAgent: 'Unexpected error: Cannot update agent. Please try again.'
            }
        }
    }
};
